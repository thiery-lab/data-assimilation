  ...
  __Pyx_RefNannySetupContext("batch_bilinear_interpolate (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_interp_points)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_fields = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[0]); if (unlikely(!__pyx_v_fields.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_interp_points = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_double(values[1]); if (unlikely(!__pyx_v_interp_points.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    if (values[2]) {
 ...
 *         int n_thread=1):
 */
  __pyx_tuple__29 = PyTuple_Pack(17, __pyx_n_s_fields, __pyx_n_s_interp_points, __pyx_n_s_n_thread, __pyx_n_s_p, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_l_ix, __pyx_n_s_r_ix, __pyx_n_s_t_ix, __pyx_n_s_b_ix, __pyx_n_s_n_field, __pyx_n_s_dim_0, __pyx_n_s_dim_1, __pyx_n_s_h_wt, __pyx_n_s_v_wt, __pyx_n_s_new_fields, __pyx_n_s_new_fields_mv); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(3, 0, 17, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dapy_integrators_interpolate_pyx, __pyx_n_s_batch_bilinear_interpolate, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dapy.integrators.interpolate", 0, __pyx_lineno, __pyx_filename);
    }
