...
ext_modules = [
    Extension('dapy.integrators.implicit_midpoint',
              ['dapy/integrators/implicit_midpoint' + c_ext],
              extra_compile_args=extra_compile_args,
              extra_link_args=extra_link_args,
              include_dirs=np_inc_dir),
    Extension('dapy.integrators.lorenz_1963',
              ['dapy/integrators/lorenz_1963' + c_ext],
              extra_compile_args=extra_compile_args,
              extra_link_args=extra_link_args,
              include_dirs=np_inc_dir),
    Extension('dapy.integrators.lorenz_1996',
              ['dapy/integrators/lorenz_1996' + c_ext],
              extra_compile_args=extra_compile_args,
              extra_link_args=extra_link_args,
              include_dirs=np_inc_dir),
